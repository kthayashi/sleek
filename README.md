...
This is the repo for my personal website, a fork of the Jekyll theme Sleek by Jan Czizikow (https://github.com/janczizikow/sleek). The original README for the Sleek repo can be found below:
